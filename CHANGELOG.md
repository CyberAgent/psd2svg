...
- **foreignObject collapsed the gap between paragraphs** (#420)
...
- **`PlaywrightRasterizer` DPI padded the canvas without scaling the content** (#418)
