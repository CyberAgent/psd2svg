...
* Centered and right-aligned lines with non-zero tracking sit up to one letter
  spacing off their Photoshop position, because CSS counts the spacing that
  follows the last character of each line
