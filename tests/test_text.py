...
def test_auto_kerning_reads_engine_data_key() -> None:
    """The canonical AutoKerning key takes precedence over the legacy alias."""
    style = StyleSheet(
        name="",
        style_sheet_data={"AutoKerning": False, "AutoKern": True},
    )
    assert style.auto_kerning is False

    legacy_style = StyleSheet(name="", style_sheet_data={"AutoKern": False})
    assert legacy_style.auto_kerning is False
